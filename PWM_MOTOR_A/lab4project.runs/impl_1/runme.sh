...
HD_PWD='C:/Users/aksel/OneDrive/Skrivebord/4-semester/DigitalProgrammerbarElektronik/Lab4/lab4project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_block_wrapper.tcl -notrace
