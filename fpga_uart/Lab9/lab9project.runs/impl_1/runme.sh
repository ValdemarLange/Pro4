...
HD_PWD='C:/Users/aksel/OneDrive/Skrivebord/4-semester/DigitalProgrammerbarElektronik/Lab9/lab9project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_block_wrapper.tcl -notrace
