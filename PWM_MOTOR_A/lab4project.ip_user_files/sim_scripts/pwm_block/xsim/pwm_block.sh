...
#
# Script generated by Vivado on Thu Mar 21 13:30:46 +0100 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pwm_block.sh
...
#
# Usage        : pwm_block.sh
#                pwm_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pwm_block.sh [-reset_run]
#                pwm_block.sh [-reset_log]
#                pwm_block.sh [-help]
#
...
# script info
echo -e "pwm_block.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pwm_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pwm_block xil_defaultlib.pwm_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pwm_block -key {Behavioral:sim_1:Functional:pwm_block} -tclbatch cmd.tcl -protoinst "protoinst_files/pwm_block.protoinst" -protoinst "protoinst_files/light.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pwm_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pwm_block.sh [-help]\n\
Usage: pwm_block.sh [-step]\n\
Usage: pwm_block.sh [-lib_map_path]\n\
Usage: pwm_block.sh [-reset_run]\n\
Usage: pwm_block.sh [-reset_log]\n\
Usage: pwm_block.sh [-keep_index]\n\
Usage: pwm_block.sh [-noclean_files]\n\n\
