...
HD_PWD='C:/Users/aksel/OneDrive/Skrivebord/4-semester/DigitalProgrammerbarElektronik/Lab9/lab9project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_block_wrapper.tcl
