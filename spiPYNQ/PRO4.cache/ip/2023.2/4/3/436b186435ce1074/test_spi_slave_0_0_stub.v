...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(o_busy, i_data_parallel, o_data_parallel, 
  ck_sck, ck_ss, ck_mosi, ck_miso)
/* synthesis syn_black_box black_box_pad_pin="o_busy,i_data_parallel[7:0],o_data_parallel[7:0],ck_ss,ck_mosi,ck_miso" */
