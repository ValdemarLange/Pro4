...
#
# Script generated by Vivado on Mon Mar 25 09:54:12 +0100 2024
...
simulate()
{
  xsim pwm_block -key {Behavioral:sim_1:Functional:pwm_block} -tclbatch cmd.tcl -protoinst "protoinst_files/pwm_block.protoinst" -log simulate.log
}
