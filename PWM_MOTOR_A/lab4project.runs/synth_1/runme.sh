...
HD_PWD='C:/Users/aksel/OneDrive/Skrivebord/4-semester/DigitalProgrammerbarElektronik/Lab4/lab4project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_block_wrapper.tcl
