...
#
# Script generated by Vivado on Tue May 14 15:28:49 +0200 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : uart_block.sh
...
#
# Usage        : uart_block.sh
#                uart_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_block.sh [-reset_run]
#                uart_block.sh [-reset_log]
#                uart_block.sh [-help]
#
...
# script info
echo -e "uart_block.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot uart_block xil_defaultlib.uart_block -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uart_block -key {Behavioral:sim_1:Functional:uart_block} -tclbatch cmd.tcl -protoinst "protoinst_files/uart_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb uart_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_block.sh [-help]\n\
Usage: uart_block.sh [-step]\n\
Usage: uart_block.sh [-lib_map_path]\n\
Usage: uart_block.sh [-reset_run]\n\
Usage: uart_block.sh [-reset_log]\n\
Usage: uart_block.sh [-keep_index]\n\
Usage: uart_block.sh [-noclean_files]\n\n\
