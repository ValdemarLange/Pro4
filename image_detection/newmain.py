...
print(colorRef)
hue_tolerance = int(input("Enter HUE tolerance: "))
saturation_tolerance = int(input("Enter SATURATION tolerance: "))
value_tolerance = int(input("Enter VALUE tolerance: "))
...
while (True):
    ...
    lower_red = np.array([colorRef[0] - hue_tolerance, colorRef[1] - saturation_tolerance, colorRef[2] - value_tolerance])
    upper_red = np.array([colorRef[0] + hue_tolerance, colorRef[1] + saturation_tolerance, colorRef[2] + value_tolerance])
