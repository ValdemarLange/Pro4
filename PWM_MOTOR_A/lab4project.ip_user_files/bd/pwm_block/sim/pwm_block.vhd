...
entity pwm_block is
  port (
    ...
    temp_cnt : out STD_LOGIC_VECTOR ( 9 downto 0 )
  );
...
begin
  ...
  temp_clk <= clk_divider_0_clk_out;
  temp_cnt(9 downto 0) <= counter_0_cnt(9 downto 0);
...
xlconstant_0: component pwm_block_xlconstant_0_0
     port map (
